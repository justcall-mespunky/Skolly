...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254769949899", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "SKOLLY", // Input Yours custom...(Maintain font for Flow)
